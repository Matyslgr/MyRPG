...
{
    if (!strcmp(action_str, "Interagir") || !strcmp(action_str, "Partir"))
    ...
    if (!strcmp(action_str, "Attaquer") || !strcmp(action_str, "Passer"))
    ...
    if (!strcmp(action_str, "Zoom -"))
        return "assets/interface/Clavier/-_light.png";
    if (!strcmp(action_str, "Déplacement") || !strcmp(action_str, "Sélectionner Choix"))
