...
button_t *new_button(char *txt)
{
    ...
    new->font = sfFont_createFromFile("assets/fonts/PoetsenOne-Regular.ttf");
...
{
    text_box->font = sfFont_createFromFile("assets/fonts/PoetsenOne-Regular.ttf");
    text_box->npc_name = sfText_create();
    sfText_setFont(text_box->npc_name, text_box->font);
    sfText_setCharacterSize(text_box->npc_name, 50);
    text_box->npc_text = sfText_create();
    sfText_setOutlineColor(text_box->npc_name, sfBlack);
    sfText_setOutlineThickness(text_box->npc_name, 4);
    sfText_setFont(text_box->npc_text, text_box->font);
    sfText_setCharacterSize(text_box->npc_text, 27);
    sfText_setOutlineColor(text_box->npc_text, sfBlack);
    sfText_setOutlineThickness(text_box->npc_text, 2);
}
...
text_box_t *init_text_box(void)
{
    ...
    set_sprite_transparent(text_box->box, 200);
